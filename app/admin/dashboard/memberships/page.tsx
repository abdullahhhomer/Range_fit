           ...
           >
             ...
             >
               <div className="bg-gray-800 border-b border-gray-700 p-4 flex items-center justify-between">
                 <h3 className="text-xl font-bold text-white">Add Visitor</h3>
                 <Button
                   variant="ghost"
                   size="sm"
                   onClick={closePopups}
               ...
               <div className="p-4 space-y-4">
                 ...
                 <div className="flex space-x-3 pt-4 border-t border-gray-700">
                   <Button
                     ...
                     className="flex-1 bg-orange-600 hover:bg-orange-700 text-white py-2 text-base font-semibold rounded-lg"
                   >
                     Add Visitor
                   </Button>
                                       <Button
                      variant="outline"
                      onClick={closePopups}
                      className="flex-1 border-orange-500/50 text-orange-400 hover:bg-orange-100 hover:border-orange-400 hover:text-orange-600 hover:scale-105 transition-all duration-200 bg-white py-2 text-base rounded-lg"
                    >
                      Cancel
                    </Button>
                 </div>
