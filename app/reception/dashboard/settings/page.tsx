    ...
    <ReceptionDashboardLayout>
      <div className="max-w-4xl mx-auto p-4 sm:p-6">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <p className="text-gray-400 text-sm sm:text-base">Manage your personal information and account settings</p>
        </div>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              {!isEditing && (
                <Button
                  ...
                  variant="outline"
                  className="w-full sm:w-auto border-orange-500/50 text-orange-400 hover:bg-orange-500/20 hover:border-orange-400 hover:text-orange-300 bg-transparent transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg hover:shadow-orange-500/20 group"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              <div>
                ...
                {isEditing ? (
                  ...
                  <div className="flex items-center space-x-2 mt-1">
                    ...
                    <span className="text-white text-sm sm:text-base">{profileData.name || "Not provided"}</span>
                  </div>
                )}
              </div>
              ...
              <div>
                ...
                <div className="flex items-center space-x-2 mt-1">
                  ...
                  <span className="text-white text-sm sm:text-base">{profileData.email}</span>
              ...
              <div>
                ...
                {isEditing && !isGenderLocked ? (
                  ...
                  >
                    <SelectTrigger className="bg-gray-700 border-gray-600 text-white mt-1 h-12 text-base">
                  ...
                  <div className="flex items-center space-x-2 mt-1">
                    <User className="h-4 w-4 text-gray-400" />
                    <span className="text-white text-sm sm:text-base">{profileData.gender || "Not provided"}</span>
                  </div>
                )}
              </div>
              ...
              <div className="md:col-span-2">
                ...
                {isEditing ? (
                  <Textarea
                    ...
                    className="bg-gray-700 border-gray-600 text-white mt-1 text-base min-h-[3rem]"
                    rows={3}
                    required
                  ...
                  <div className="flex items-start space-x-2 mt-1">
                    ...
                    <span className="text-white text-sm sm:text-base">{profileData.address || "Not provided"}</span>
                  </div>
                )}
              </div>
            </div>
            ...
            {isEditing && (
              <div className="flex flex-col sm:flex-row gap-3 mt-6">
                <Button
                  ...
                  disabled={loading}
                  className="w-full sm:w-auto bg-orange-600 hover:bg-orange-700 text-white flex items-center justify-center gap-1 transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg hover:shadow-orange-500/30 disabled:hover:scale-100 disabled:hover:shadow-none group h-12 text-base"
                >
                ...
                <Button
                  ...
                  variant="outline"
                  className="w-full sm:w-auto border-orange-500/50 text-orange-400 hover:bg-orange-500/20 hover:border-orange-400 hover:text-orange-300 bg-transparent transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg hover:shadow-orange-500/20 group h-12 text-base"
                >
                  <X className="h-4 w-4 mr-2 transition-transform duration-300 group-hover:rotate-12" />
                  Cancel
                </Button>
              </div>
            )}
            ...
            <div className="space-y-4 sm:space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-gray-700/30 rounded-lg">
                    ...
                    <div className="md:col-span-3 flex flex-col sm:flex-row gap-3">
                      <Button
                        ...
                        disabled={loading}
                        className="w-full sm:w-auto bg-orange-600 hover:bg-orange-700 text-white transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg hover:shadow-orange-500/30 disabled:hover:scale-100 disabled:hover:shadow-none group h-12 text-base"
                      >
                        <Lock className="h-4 w-4 mr-2 transition-transform duration-300 group-hover:scale-110" />
              ...
              <div className="border-t border-gray-700 pt-4 sm:pt-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 text-xs sm:text-sm">
                  ...
                  <div className="flex items-center space-x-2">
                    <CheckCircle className="h-3 w-3 sm:h-4 sm:w-4 text-gray-400" />
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-white font-mono ml-2 break-all">{fullUserData?.memberId || 'N/A'}</span>
                  </div>
                  <div className="flex items-center space-x-2">
